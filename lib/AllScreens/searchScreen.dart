...
import 'package:rhs_app/AllWidgets/Divider.dart';
import 'package:rhs_app/AllWidgets/progressDialog.dart';
...
import 'package:rhs_app/Models/placePredictions.dart';
...
class PredictionTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton(
      ...
      onPressed: () {
        getPlacedAddressDetails(placePredictions.place_id, context);
      },
      child: Container(
          child: Column(
            children: [
  ...
  void getPlacedAddressDetails(String placeId, context) async
  {
    showDialog(
        context: context,
    ...
    if(res["status"] == "OK")
      {
        Address address = new Address(placeFormattedAddress: "", placeName: "", placeId: "", latitude: 0, longitude: 0);
